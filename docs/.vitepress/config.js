    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Day 3：认识 vim 语法', link: '/vim/day-3.md' },
          { text: 'Day 4：删改重做命令提升效率', link: '/vim/day-4.md' },
          { text: 'Day 5：认识可视化模式', link: '/vim/day-5.md' },
          { text: 'Day 6：什么是文本对象？', link: '/vim/day-6.md' },
          { text: 'Day 7：让移动再次快起来!', link: '/vim/day-7.md' },
          { text: 'Day 8：掌握搜索命令', link: '/vim/day-8.md' },
          { text: 'Day 9：vim-easymotion', link: '/vim/day-9.md' },
          { text: 'Day 10：数字与 `.` 的威力', link: '/vim/day-10.md' },
          { text: 'Day 11：多文件跳转的奥妙', link: '/vim/day-11.md' },
          { text: 'Day 12：vim-surround', link: '/vim/day-12.md' },
          { text: 'Day 13：替换字符和多文本选中', link: '/vim/day-13.md' },
          { text: 'Day 14：大小写、注释与提示', link: '/vim/day-14.md' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Day 29：终端的基本操作",  link: '/vscode/day-29.md'},
          { text: "Day 30：Debug the Bug",  link: '/vscode/day-30.md'},
        ]
      } 
    ],
    algolia: {
